...
CREATE DATABASE empresa_seu_nome;
...
-- CORRIGIDO: usa empresa_seu_nome
WHERE table_schema = 'empresa_seu_nome';
...
-- Remover triggers (necessário redefinir o DELIMITER antes de dropar, dependendo do ambiente)
DELIMITER ;
